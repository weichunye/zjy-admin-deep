	...
	export default {
      ...
      Heade
        ...
        dataList:[
          ...
          {name:'《从零开始学电路基础》资料下载','desc':'《从零开始学电路基础》所介绍的电路基础知识包括：电路的基本定律、定理和基本分析方法，磁场与磁路，交流电路，互感与变压器，电路的过渡过程等内容。 ','desc1':'pdf','img':require("../../assets/pic/pic_8.jpg")},
          {name:'《Excel高级报表宝典》','desc':'本书集中讨论了Excel关于报表开发的所有问题。主要介绍了Excel中最为常用的数据透视表、电子表格报表、参数查询及Web组件等的特点和应用场合及报表开发过程， ','desc1':'pdf','img':require("../../assets/pic/pic_9.jpg")},
          {name:'扫描版《鬼谷子绝学》','desc':'《鬼谷子绝学》一个人缺的永远不是钱，缺的是赚钱的智谋，一个人缺的永远不是团队，缺的是俘获追随者的能力，一个人缺的永远不是人们的爱戴和拥戴，缺的是领导统驭的智慧，本书着重于辩证的实践方法 ','desc1':'pdf','img':require("../../assets/pic/pic_10.jpg")}
        ],
